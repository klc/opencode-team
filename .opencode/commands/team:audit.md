---
description: Full project audit — security vulnerabilities, performance bottlenecks, code quality, and technical debt. Runs through backend-lead because it has permission to invoke the audit specialists.
agent: backend-lead
subtask: true
---
