...
For full-stack stories, create separate backend and frontend tasks instead of one `scope: "both"` in-progress task. Group Kanban tasks by backend and frontend scope.

## Step 3b — Execute

Do not stop after creating the Kanban tasks — call the leads:

1. Call @backend-lead with all backend Kanban task IDs and context via Task tool
2. Call @frontend-lead with all frontend Kanban task IDs and context via Task tool
