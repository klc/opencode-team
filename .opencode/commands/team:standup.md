...
2. Fetch active Kanban tasks for live board state:
   ...
   Use the returned active tasks to populate the "In Progress" section. For the "Blocked" section, use reopened tasks, tasks with failure notes, or todo items that explicitly mention a blocker. Kanban data takes precedence over todo list for task status.
