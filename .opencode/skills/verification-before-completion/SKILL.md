...
description: Load before reporting any task, fix, or feature as complete. Requires running actual commands and reading actual output before claiming success. "I think it works" is not verification.
---
...
```bash
# Run the actual test command from project-stack skill
...
## For Developer Agents (senior/junior backend/frontend)

Your completion report to the lead MUST include actual verification output:

```
✅ IMPLEMENTATION COMPLETE — [KAN-XXX]
